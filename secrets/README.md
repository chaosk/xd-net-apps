...
| `homepage-oidc.yaml` | `homepage` | Homepage built-in auth: `HOMEPAGE_AUTH_SECRET`, `HOMEPAGE_OIDC_CLIENT_ID`, `HOMEPAGE_OIDC_CLIENT_SECRET` for Authentik OIDC ([auth docs](https://gethomepage.dev/installation/#security-authentication)). See `apps/homepage/README.md`. |
